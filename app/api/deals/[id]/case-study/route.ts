...
export async function POST(
  ...
  const dealContext = `Client: ${deal.client_name ?? "—"} at ${deal.client_company ?? "—"}. Pain: ${deal.pain_point ?? "n/a"}. Timeline: ${deal.timeline ?? "n/a"}. Proposed amount: ${deal.proposed_amount ?? "n/a"}. Notes: ${deal.notes ?? "n/a"}.`;
